...
<html lang="es"> 
  ...
  <center>
    ...
    <label>Precio De La Venta :
        <input type="number" name="PrecioDetalleVenta" class="form-control" required>
        </label><br><br>
    <label>Fecha De La Venta  :
        <input type="date" name="fecha_Inicio" class="form-control" required>
       </label><br><br>
    <label>Fecha Limite Garantia  :
        <input type="date" name="fecha_Fin_garantia" class="form-control" required>
        </label><br><br>
    <label>Descripción :   </label><br>
       <textarea  type="text" name="DescripcionVenta" class="form-control" cols="40" rows="5" required></textarea>
       <br><br> 
    <label>IdLlanta  :
        <input type="number" name="IdLlanta" class="form-control" required>
        </label><br><br>
     <label>IdUsuario   :
