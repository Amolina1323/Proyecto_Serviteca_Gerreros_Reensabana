...
<h2> CREAR SERVICIO</h2>
    ...
    <label>Precio (Vehiculo liviano) :
        <input type="number" name="PrecioServicioLiviano" class="form-control" required>
       </label><br><br>
    <label>Precio (Vehiculo mediano) :
        <input type="number" name="PrecioServicioMediano" class="form-control" required>
    </label><br><br>
    <label>Precio (Vehiculo pesado) :
        <input type="number" name="PrecioServicioPesado" class="form-control" required>
    </label><br><br>
    <label>Estado :
        <br> <br>
        <select name="Estado" >
