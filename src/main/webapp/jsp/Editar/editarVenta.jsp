...
<%@ page import="co.edu.sena.project2687351.model.Venta" %>
<%
...
<html lang="es"> 
  ...
  <main class="main">
    ...
    <h1>Consulta Especifica</h1>
        ...
        <div class="content">
            <center>
            <form method="POST" action="../../../Project-2687351-1.0-SNAPSHOT/Venta-Consult">
                <BR>
                <label> Id Venta : </label>
                <input type="number" name="IdVenta" class="form-control"><br>
...
<!--FORMULARIO DONDE SE MOTRARÁN LOS DATOS ASOCIADOS AL CODIGO DIGITADO-->
            ...
            <center>
                ...
                <BR><BR>
                <label>ID :
                    <input type="number" name="IdVenta" class="form-control" value="<%= venta.getIdVenta()  %>"  required>
                </label><br><br>
                    <label>Precio De La Venta :
                        <input type="number" name="PrecioDetalleVenta" class="form-control" value="<%= venta.getPrecioDetalleVenta()  %>" required>
                        </label><br><br>
                    <label>Fecha De La Venta  :
                        <input type="date" name="fecha_Inicio" class="form-control" value="<%= venta.getFechaInicio()  %>" required>
                       </label><br><br>
                    <label>Fecha Limite Garantia  :
                        <input type="date" name="fecha_Fin_garantia" class="form-control" value="<%= venta.getFechaFin()  %>" required>
                        </label><br><br>
                    <label>Descripción :   </label><br>
                       <textarea  type="text" name="DescripcionVenta" class="form-control" cols="40" rows="5" required><%= venta.getDescripcionVenta()  %></textarea>
                       <br><br> 
                    <label>IdLlanta  :
                        <input type="number" name="IdLlanta" class="form-control" value="<%= venta.getIdLlanta()  %>" required>
                        </label><br><br>
                     <label>IdUsuario   :
                        <input type="number" name="IdUsuario" class="form-control" value="<%= venta.getIdUsuario()  %>" required>
                        </label><br><br>
                     <label>IdCliente   :
                        <input type="text" name="IdCliente" class="form-control" value="<%= venta.getIdCliente()  %>" required>
                        </label><br><br>
                    <% if (rol == 1 || rol == 2) {%>
                    <div class="grupo boton animacion" >
                        <br>
            ...
            <script>
                function editar() {
                    ...
                    if(rest == true){
                        document.getElementById("Formulario").action = "../../../Project-2687351-1.0-SNAPSHOT/Venta-Update";
                ...
                function eliminar() {
                    ...
                    if(rest == true){
                        document.getElementById("Formulario").action = "../../../Project-2687351-1.0-SNAPSHOT/Venta-Delete";
                        document.getElementById("Formulario").submit();
                    }else {
