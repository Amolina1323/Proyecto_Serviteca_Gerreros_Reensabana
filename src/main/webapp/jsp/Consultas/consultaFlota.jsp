...
<main class="main">
  <div class="container">
    ...
    <!-- Formulario -->
    <h1>FLOTAS</h1>
    <button><a href="../Editar/editarCliente.jsp">CONSULTA ESPECIFICA</a> <br></button><br>
      <button><a href="consultaVehiculoFlota.jsp">CONSULTA VEHICULOS DE FLOTA</a></button>
    <center>
      <table class="table table-dark table-striped">

        <tr>
          <td class="cabezacon">NOMBRE</td>
          <td class="cabezacon">EMPRESA</td>
        ...
        <% Repository<Cliente> repository = new ClienteRepositoryImpl();
          try {
            List<Cliente> Clientes = ((ClienteRepositoryImpl) repository).listAllObjF();
