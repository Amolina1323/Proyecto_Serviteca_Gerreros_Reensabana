...
<main class="main">
    <div class="container">
        ...
        <div class="content">
            <center>
                <form method="POST" action="../../../Project-2687351-1.0-SNAPSHOT/VehiculoFlo-Consult">
                    <BR>
                    <label> Nit Flota :
            ...
            <table class="table table-dark table-striped">
                <h1>VEHICULOS</h1>
                <button><a href="../../../Project-2687351-1.0-SNAPSHOT/jsp/Editar/editarVehiculo.jsp">CONSULTA ESPECIFICA</a> <br></button><br>
                <tr>
