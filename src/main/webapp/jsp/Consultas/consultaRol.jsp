...
<%@ page import="co.edu.sena.project2687351.model.Rol" %>
<%@ page import="co.edu.sena.project2687351.model.repository.RolRepositoryImpl" %>
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../../Project-2687351-1.0-SNAPSHOT/css/editarLlanta.css">
...
<main class="main">
  <div class="container">
    ...
    <button><a href="#">CONSULTA ESPECIFICA</a></button>
    <center>
      <table class="table table-dark table-striped">
        ...
        <% Repository<Rol> repository = new RolRepositoryImpl();
          try {
            List<Rol> Roles = repository.listAllObj();
            for (Rol roles : Roles) {
        ...
        <tr>
          ...
          <td>
            <a href="#" class="btn-primary bg-primary"> EDITAR </a>
            <a href="#" class="btn-primary bg-danger"> ELIMINAR </a>
          </td>
        </tr>
        <% }
