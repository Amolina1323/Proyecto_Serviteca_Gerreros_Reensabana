...
<%@ page import="co.edu.sena.project2687351.model.repository.LlantaRepositoryImpl" %>
...
<main class="main">
    <div class="container">
        ...
        <!-- Formulario -->
        <h1>LLANTAS</h1>
        <button> <a href="../Editar/editarLlanta.jsp">CONSULTA ESPECIFICA</a></button>
        <center>
            <table class="table table-dark table-striped">

                <tr>
                    <td class="cabezacon">ID LLANTA</td>
                    <td class="cabezacon">MARCA</td>
                    <td class="cabezacon">TIPO</td>
                    <td class="cabezacon">MODELO</td>
                    <td class="cabezacon">DIMENSION</td>
                    <td class="cabezacon">DISEÑO</td>
                    <td class="cabezacon">FECHA LLANTA</td>
                    <td class="cabezacon">PROFUNDIDAD LLANTA</td>
                </tr>
                <% Repository<Llanta> repository = new LlantaRepositoryImpl();
                    try {
                        List<Llanta> Llantas = repository.listAllObj();
                        for (Llanta llanta : Llantas) {


                %>
                <tr>
                    <td><%=llanta.getIdLlanta()%></td>
                    <td><%=llanta.getMarca()%></td>
                    <td><%=llanta.getTipo()%></td>
                    <td><%=llanta.getModelo()%></td>
                    <td><%=llanta.getDimension()%></td>
                    <td><%=llanta.getDiseno()%></td>
                    <td><%=llanta.getFechaLlanta()%></td>
                    <td><%=llanta.getProfundidadLlanta()%></td>
                </tr>
                <% }
