...
<%@ page import="co.edu.sena.project2687351.model.repository.ServicesRepositoryImpl" %>
...
<main class="main">
    <div class="container">
        ...
        <!-- Formulario -->
        <h1>SERVICIOS</h1>
        <button><a href="../Editar/editarServicio.jsp">CONSULTA ESPECIFICA</a></button>
        <center>
            <table class="table table-dark table-striped">
                ...
                <tr>
                    ...
                    <td class="cabezacon">ESTADO</td>
                    <td class="cabezacon">PRECIO SERVICIO LIVIANO</td>
                    <td class="cabezacon">PRECIO SERVICIO MEDIANO</td>
                    <td class="cabezacon">PRECIO SERVICIO PESADO</td>
                    <td class="cabezacon">DESCRIPCION</td>
                </tr>
                <% Repository<Services> repository = new ServicesRepositoryImpl();
                    try {
                        List<Services> Servic = repository.listAllObj();
                        for (Services servicio : Servic) {
                ...
                <tr>
                    ...
                    <td><%=servicio.getPrecioServicioLiviano()%></td>
                    <td><%=servicio.getPrecioServicioMediano()%></td>
                    <td><%=servicio.getPrecioServicioPesado()%></td>
