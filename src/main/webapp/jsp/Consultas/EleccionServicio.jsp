        ...
        <center>
            <H1>Tipo de Vehiculo</H1>
                ...
                <div class="grupo boton animacion" >
                    <br>
                    <button><a href="registrarServicio.jsp"><strong>LIVIANO</strong></a></button>
                </div>
            <div class="grupo boton animacion" >
                <br>
                <button><a href="registrarServicio.jsp"><strong>MEDIANO</strong></a></button>
            </div>
            <div class="grupo boton animacion" >
                <br>
                <button><a href="registrarServicio.jsp"><strong>PESADO</strong></a></button>
            </div>
