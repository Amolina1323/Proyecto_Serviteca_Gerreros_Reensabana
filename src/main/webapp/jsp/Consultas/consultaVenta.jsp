...
<%@ page import="co.edu.sena.project2687351.model.repository.VentaRepositoryImpl" %>
...
<main class="main">
  <div class="container">
    ...
    <!-- Formulario -->
    <h1>VENTAS</h1>
    <button><a href="../Editar/editarVenta.jsp">CONSULTA ESPECIFICA</a></button>
    <center>
      <table class="table table-dark table-striped">
        ...
        <tr>
          ...
          <td class="cabezacon">FECHA INICIO</td>
          <td class="cabezacon">FECHA FIN</td>
        ...
        <% Repository<Venta> repository = new VentaRepositoryImpl();
          try {
            List<Venta> Ventas = repository.listAllObj();
        ...
        <tr>
          ...
          <td><%=venta.getPrecioDetalleVenta()%></td>
          <td><%=venta.getFechaInicio()%></td>
          <td><%=venta.getFechaFin()%></td>
          <td><%=venta.getIdLlanta()%></td>
          <td><%=venta.getIdUsuario()%></td>
          <td><%=venta.getIdCliente()%></td>
          <td><%=venta.getDescripcionVenta()%></td>
        </tr>
        <% }
